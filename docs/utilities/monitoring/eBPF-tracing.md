...
В рамках проекта, полезными могут оказаться утилиты по типу cpudist, cpustolen.bt, workq.bt, runqlen, runqlat и другие программы, собирающие и отображающие статистику о работе конкретных механизмов внутри тестируемой системы. Например можно создать нагрузку на ситсему, после чего использовать один или несколько из упомянутых инструментов чтобы оценить эффективность работы системы в данных условиях. Однако сами сценарии нагрузки а также методы оценивания придется продумывать и реализовывать самостоятельно.
