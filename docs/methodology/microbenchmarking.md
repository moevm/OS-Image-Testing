...
В тестировании образов ОС микробенчмаркинг может быть использован для оценки производительности файловой и сетевой подсистем, определения скорости выполнения операций, выявления задержек.
