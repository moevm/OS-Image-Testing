...
* Низкие: сбор и анализ доступной статической конфигурации
* Средние: запуск проверочных тестов, сбор облачных ограничений провайдера
* Высокие: построение полного опросника по всем подсистемам и средам, обработка случаев, когда данные недоступны или неполны. Часть сведений может не определяться статически и требует внешних источников или практической проверки.
