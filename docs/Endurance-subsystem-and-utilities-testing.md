...
| **vdbench**      | Создание нагрузки на систем хранения данных.                                                                                         |
...
Входит в стандартный набор программ PostgreSQL, поэтому он работает на всех стандартных ОС при наличии созданной базы данных.
